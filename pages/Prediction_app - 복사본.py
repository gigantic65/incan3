...
def app():
    ...
    df = pd.read_csv('train_incan.csv')
    ...
    if selected2 == '조색배합 예측':
        ...
        if st.button('Run Prediction',key = count):
            ...
            if selected2 =='Base_C':
                ...
                if Target_v[0] > 50.0 and Target_v[1] > 0.0 and Target_v[2] > 0.0:
                    para3 = pd.read_csv('data000.csv')
                                        
                if Target_v[0] > 50.0 and Target_v[1] > 0.0 and Target_v[2] < 0.0:
                    para3 = pd.read_csv('data00_0.csv')
                    
                if Target_v[0] > 50.0 and Target_v[1] < 0.0 and Target_v[2] > 0.0:
                    para3 = pd.read_csv('data0_00.csv')
                    
                if Target_v[0] > 50.0 and Target_v[1] < 0.0 and Target_v[2] < 0.0:
                    para3 = pd.read_csv('data0_0_0.csv')
                    
                     
                if Target_v[0] < 50.0 and Target_v[1] > 0.0 and Target_v[2] > 0.0:
                    para3 = pd.read_csv('data_000.csv')
                    
                if Target_v[0] < 50.0 and Target_v[1] > 0.0 and Target_v[2] < 0.0:
                    para3 = pd.read_csv('data_00_0.csv')
                    
                if Target_v[0] < 50.0 and Target_v[1] < 0.0 and Target_v[2] > 0.0:
                    para3 = pd.read_csv('data_0_00.csv')
                    
                if Target_v[0] < 50.0 and Target_v[1] < 0.0 and Target_v[2] < 0.0:
                    para3 = pd.read_csv('data_0_0_0.csv')
            ...
            for j in range(df_min0.shape[0]-11):
                ...
                """ad0 = 20
                if df_min0.iloc[j] < 50:
                    ad0 = 5
                if df_min0.iloc[j] < 200:
                    ad0 = 10
                if df_min0.iloc[j] < 500:
                    ad0 = 15"""

                    
                if df_min0.iloc[j] > 0:
                    min = round(df_min0.iloc[j] - 40,0)
                    if min <0: min = 0 
                    max = round(df_min0.iloc[j] + 60,0)
                    #st.write(max, min)
            ...
            for j in range(df_min1.shape[0]-11):
                ...
                if df_min1.iloc[j] > 0:
                    min = round(df_min1.iloc[j] - 40,0)
                    if min <0: min = 0 
                    max = round(df_min1.iloc[j] + 60,0)
                    #st.write(max, min)
                    para = np.arange(min, max, (max-min)/20.0)  
            ...
            #para7.drop(['index'],axis=1,inplace=True)
            ...
            for j in range(df_min2.shape[0]-11):
                ...
                if df_min2.iloc[j] > 0:
                    min = round(df_min2.iloc[j] - 5,0)
                    if min <0: min = 0 
                    max = round(df_min2.iloc[j] + 5,0)
                    #st.write(max, min)
            ...
            st.write('**3차 선정 조색제 배합:**')
            st.write(para8.head(3))
            ...
            df_min3 = pd.concat([df_min,df_min1,df_min2], axis=0)
